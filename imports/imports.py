...
class ConvolutionIntroduction(ThreeDScene):
    def construct(self):
        ...
        image = Image.open('../data/mario.png')
        # image = Image.open(get_full_raster_image_path("../data/Lenna"))
        print(image)
        ...
        print(Square(fill_color=rgb_to_hex(arr[0, 1] / 255), fill_opacity=1).get_fill_rgbas()[0])
        ...
        def step(pos=0):
            ...
            new_array[pos].get_fill_rgbas()[0] = rgba
